...
module.exports = {
	...
	targets: {
		...
		'./assets/js/dependencies/connection.example.js': { template: 'assets/js/dependencies/connection.example.js' },
		'./assets/js/dependencies/sails.io.js': { template: 'assets/js/dependencies/sails.io.js' },
		'./assets/js/dependencies/socket.io.js': { template: 'assets/js/dependencies/socket.io.js' },

		// optional - inject other dependencies
		'./assets/js/dependencies/angular.min.js': { exec: function (scope, cb) {
			if (scope.frontendFramework !== 'angular') return cb();
