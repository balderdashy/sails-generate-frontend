...
module.exports = {
	...
	targets: {
		...
		'./assets/scripts/dependencies': { folder: {} },
		'./assets/scripts/dependencies/sails.io.js': { template: 'assets/scripts/dependencies/sails.io.js' },

		'./assets/images/.gitkeep': { copy: '.gitkeep'},
		'./assets/templates/.gitkeep': { copy: '.gitkeep'},
		// optional - inject other dependencies
		'./assets/scripts/dependencies/angular.min.js': { exec: function (scope, cb) {
				if (scope.frontend !== 'angular') return cb();
				var src = require('path').resolve(__dirname,'../templates/assets/scripts/dependencies/angular.min.js');
