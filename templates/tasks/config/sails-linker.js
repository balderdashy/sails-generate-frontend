...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    devJsJade: {
      ...
      files: {
        'views/**/*.@(jade|pug)': require('../pipeline').jsFilesToInject
      }
    },
    ...
    prodJsJade: {
      ...
      files: {
        'views/**/*.@(jade|pug)': ['.tmp/public/min/production.min.js']
      }
    },
    ...
    devStylesJade: {
      ...
      files: {
        'views/**/*.@(jade|pug)': require('../pipeline').cssFilesToInject
      }
    },
    ...
    prodStylesJade: {
      ...
      files: {
        'views/**/*.@(jade|pug)': ['.tmp/public/min/production.min.css']
      }
    },
    ...
    devTplJade: {
      ...
      files: {
        'views/**/*.@(jade|pug)': ['.tmp/public/jst.js']
      }
    }
  });
